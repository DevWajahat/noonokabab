                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <h4 class="text-center mb-4 text-white login-signup-title">Reset Password</h4>
                                    <form action="{{ route('password.update') }}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label class="mb-1 text-white"><strong>Email</strong></label>
                                            <input type="email" value="{{ $instance->email }}"
                                                class="form-control @error('email') is-invalid @enderror" readonly
                                                name="email" placeholder="hello@example.com">
                                            @error('email')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password"
                                                ...
                                                name="password" placeholder="hello@example.com">
                                            @error('password')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password"
                                                ...
                                                name="password_confirmation" placeholder="hello@example.com">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn bg-white text-black btn-block">Update Password</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
