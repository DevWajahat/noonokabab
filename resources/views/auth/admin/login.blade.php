                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="{{ route('admin.login') }}" method="post">
                                        ...
                                        {{-- <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                            <div class="form-group">
                                                <div
                                                    class="custom-control d-flex justify-content-start align-items-center gap-2 custom-checkbox ms-1 text-white">
                                                    <input type="checkbox"
                                                        class="custom-control-input remember-checkbox"
                                                        id="basic_checkbox_1">
                                            ...
                                            <div class="form-group">
                                                <a class="text-white" href="page-forgot-password.php">Forgot
                                                    Password?</a>
                                            </div>
                                        </div> --}}
