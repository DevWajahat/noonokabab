      ...
      <div class="buttons">
         ...
         <div class="form-container sign-up-container">
            <form action="#">
               ...
               <div class="input-container">
                  <input class="input-fields-form mb-0" type="password" id="passwordInput1" placeholder="Password" />
         ...
         <div class="form-container sign-in-container">
            <form action="#">
               ...
               <input class="input-fields-form" type="email" placeholder="Email" />
               <div class="input-container">
                  <input class="input-fields-form mb-0" type="password" id="passwordInput2" placeholder="Password" />
