                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        <div class="client-input">
                                            ...
                                            <input class="card-field-input @error('first_name') is-invalid @enderror"
                                                name="first_name" placeholder="" type="text" value="{{ old('first_name') }}" >
                                            @error('first_name')
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="client-input">
                                            ...
                                            <input class="card-field-input @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" placeholder="" type="text">
                                        </div>
                                        @error('last_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="client-input">
                                            ...
                                            <input class="card-field-input @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="" type="email">
                                            @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="client-input">
                                            ...
                                            <input class="card-field-input @error('phone') is-invalid  @enderror" value="{{ old('phone') }}" name="phone" placeholder="" type="number">
                                            @error('phone')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="client-input">
                                            ...
                                            <textarea class="card-field-input" name="message" id="">{{ old('message') }}</textarea>
                                            @error('message')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12 ">
                                        <div class="free-qoute-radio">
                                            ...
                                            <label class="checkbox-label mt-1" for="i-agree">I agree to receive discount
                                                and special offer e-mails from Chicago Persian Restaurant - Authentic
                                                Persian Cuisine - Middle Eastern Food - Mediterranean Dining</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
