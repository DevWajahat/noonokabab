      ...
      <div class="deznav">
        <div class="deznav-scroll">
          <ul class="metismenu" id="menu">
            ...
            <li class="has-menu">
              <a class="has-arrow ai-icon" href="orders.php" aria-expanded="false">
            ...
            <li class="has-menu">
              <a class="has-arrow ai-icon" href="users.php" aria-expanded="false">
            ...
            <li class="has-menu">
              ...
              <ul class="metismenu" id="menu">
                <li class="has-menu">
                  <a class="has-arrow ai-icon" href="add-branch.php" aria-expanded="false">
                    <span class="nav-text">Add Branch</span>
                  </a>
                </li>
                <li class="has-menu">
                  <a class="has-arrow ai-icon" href="branches.php" aria-expanded="false">
            ...
            <li class="has-menu">
              ...
              <ul class="metismenu" id="menu">
                <li class="has-menu">
                  <a class="has-arrow ai-icon" href="add-lunchtime.php" aria-expanded="false">
                    <span class="nav-text">Add Lunch Time</span>
                  </a>
                </li>
                <li class="has-menu">
                  <a class="has-arrow ai-icon" href="lunchtime.php" aria-expanded="false">
