	...
	<div class="container-fluid">
		<div class="row mb-4">
			<div class="col-12">
				<div class="bg-white">
					<div class="card-body">
                        <h4 class="section-title">Add Location</h4>
                        <form action="." class="mb-0">
                            <div class="row">
                                <div class="mb-3 col-12 col-lg-6">
                                    <label class="form-label">Location Name</label>
                                    <input type="text" placeholder="Location Name" name="" id="" class="form-control">
                                </div>
                                <div class="mb-3 col-12 col-lg-6">
                                ...
                                <div class="mb-3 col-12 col-lg-6">
                                    ...
                                    <input type="number" placeholder="Zip" name="" id="" class="form-control">
                                </div>
