                            ...
                            <form action="." class="mb-0">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-12 col-lg-6">
                                        ...
                                        <input type="text" placeholder="Menu Name" name="" id=""
                                            class="form-control">
                                    </div>
                                    <div class="mb-3 col-12 col-lg-6">
                                        <label class="form-label">Price</label>
                                        <input type="number" placeholder="Price" name="" id=""
                                            class="form-control">
                                    </div>
                                    <div class="mb-3 col-12 col-lg-6">
                                        <label class="form-label">Upload Image</label>
                                        <input type="file" placeholder="Price" name="" id=""
                                            accept="image/*" class="form-control ">
                                    </div>
                                    <div class="mb-3 col-12 col-lg-6">
                                        <div class="d-flex justify-content-start align-items-center gap-3">
                                            <input id="regular" class="input-checkbox" type="checkbox" name="menu"
                                                id="">
                                    ...
                                    <div class="mb-3 col-12 col-lg-6">
                                        <div class="d-flex justify-content-start align-items-center gap-3">
                                            <input id="lunch-special" class="input-checkbox" type="checkbox" name="menu"
                                                id="">
