        ...
        <div class="container-fluid">
            <div class="row mb-4">
                <div class="col-12">
                    <div class="bg-white">
                        <div class="card-body">
                            <h4 class="section-title">Edit Ingredeints </h4>
                                ...
                                <div class="row">
                                    <div class="mb-3 col-12 ">
                                        ...
                                        <div class="mb-3 col-12 option">
                                            ...
                                            <input type="number" placeholder="Price" name="price" value="{{ $ingredient->price }}"
                                                id="" step=".01"
                                    ...
                                    <div class="col-12 text-end">
                                        <button class="btn btn-primary bg-deepblue" type="submit">Update Ingredients</button>
                                    </div>
                                </div>
                            </form>
                        </div>
